                        ...
                        <div class="card card-flush py-4">
                            ...
                            <div class="card-body pt-0">
                                <div class="mb-10 fv-row">
                                    ...
                                    <div class="d-flex">
                                        <input type="text" id="name" name="name" class="form-control"
                                            placeholder="Shift name" value="{{ old('name', $shift->name) }}" required />
                                    </div>
                                </div>
                                <div class="mb-10 fv-row">
                                        ...
                                        <div class="fv-row w-100 flex-md-root">
                                            ...
                                            <div class="d-flex">
                                                <input type="text" class="form-control timepicker" placeholder="00:00:00"
                                                    ...
                                                    value="{{ old('in_time_last') ?? ($shift->in_time_last ? date('h:i', strtotime($shift->in_time_last)) : '') }}" />
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                        ...
                                        <div class="fv-row w-100 flex-md-root">
                                            ...
                                            <div class="d-flex">
                                                <input type="text" class="form-control timepicker"
                                                    ...
                                                    value="{{ old('out_time_last') ?? ($shift->out_time_last ? date('h:i', strtotime($shift->out_time_last)) : '') }}" />
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                <div class="mb-10 fv-row">
                                    ...
                                    <div class="d-flex">
                                        <input type="number" id="break_time" name="break_time" class="form-control"
                                            placeholder="00" value="{{ old('break_time', $shift->break_time) }}" />
                                    </div>
                                </div>
                            </div>
                        </div>
                        <div class="d-flex justify-content-end">
                            <a href="{{ route('shift.index') }}" id="shift_cancel" class="btn btn-light me-5">Cancel</a>
