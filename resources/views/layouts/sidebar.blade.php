@php
    ...
    $forceAttendanceNav = Request::is('force-attendance*');
    $leaveManagementNav = Request::is('leave-attendance*');
    $quickAttendanceNav = Request::is('quick-attendance*');
    $monthlyAttendanceNav = Request::is('monthly-attendance*');
    $leaveApplicationNav = Request::is('leave-application*');
@endphp
                ...
                <div data-kt-menu-trigger="click"
                    ...
                    <div class="menu-sub menu-sub-accordion menu-active-bg">
                        ...
                        <div data-kt-menu-trigger="click"
                            ...
                            <div class="menu-sub menu-sub-accordion menu-active-bg">
                                <div class="menu-item">
                                    <a class="menu-link @yield('event')" href="{{ route('event.index') }}">
                                        <span class="menu-bullet">
                                            <span class="bullet bullet-dot"></span>
                                        </span>
                                        <span class="menu-title">Event</span>
                        ...
                        <div data-kt-menu-trigger="click"
                            class="menu-item menu-accordion {{ $leaveNav || $leaveAloneNav || $leaveAssignmentNav ? 'here show' : '' }}">
                            <span class="menu-link">
                                <span class="menu-bullet">
                                    <span class="bullet bullet-dot"></span>
                                </span>
                            ...
                            <div class="menu-sub menu-sub-accordion menu-active-bg">
                                <div class="menu-item">
                                    <a class="menu-link @yield('leave')" href="{{ route('leave.index') }}">
                                        <span class="menu-bullet">
                                            <span class="bullet bullet-dot"></span>
                                        </span>
                                        <span class="menu-title">Leave</span>
...
{{--                @endhasAnyRole--}}
                <div data-kt-menu-trigger="click"
                    ...
                    <div class="menu-sub menu-sub-accordion menu-active-bg">
                        <div class="menu-item">
                            <a class="menu-link @yield('force_attendance')" href="{{ route('force-attendance.index') }}">
                                <span class="menu-bullet">
                                    <span class="bullet bullet-dot"></span>
                                </span>
                ...
                <div class="menu-item">
                    <a class="menu-link @yield('leave_application')" href="{{ route('leave-application.index') }}">
                        <span class="menu-icon">
                            <span class="svg-icon svg-icon-2">
                                <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24"
                                    viewBox="0 0 24 24" fill="none">
                ...
                <div data-kt-menu-trigger="click"
                    ...
                    <span class="menu-link">
                        ...
                        <span class="menu-title">Dynamic Values</span>
                        <span class="menu-arrow"></span>
                    </span>
                    <div class="menu-sub menu-sub-accordion menu-active-bg">
                        <div class="menu-item">
                ...
                <div data-kt-menu-trigger="click"
                    class="menu-item menu-accordion {{ $quickAttendanceNav || $monthlyAttendanceNav ? 'here show' : '' }}">
                    <span class="menu-link">
                        <span class="menu-icon">
                            <span class="svg-icon svg-icon-2">
                                <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24"
